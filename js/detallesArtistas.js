...
agregarAMiPlaylist.addEventListener("click", function(e) {
    ...
    if (agregarAMiPlaylist.innerHTML == "Agregar a mi playlist") {
        ...
        cancionesFavoritas.push(nombreCanción.innerHTML)
        ...
        let indiceCanción = cancionesFavoritas.indexOf(nombreCanción.innerHTML) //Te da el índice de la canción que le pases en el array
